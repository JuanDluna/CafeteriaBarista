    ...
    <main>
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#submitNewClient").click(function(e) {
                    e.preventDefault();
                    var formData = $("#newClientForm").serialize();

                    $.ajax({
                        type: "POST",
                        url: "procesar_reservacion.php",
                        data: formData,
                        dataType: "json", // Especifica el tipo de datos esperado en la respuesta
                        success: function(response) {
                            if (response.success) {
                                // Si la operación fue exitosa
                                alert("Reserva exitosa. ID del nuevo cliente: " + response.idCliente);
                                // Aquí puedes realizar otras acciones, redireccionar, etc.
                            } else {
                                // Si hubo un error
                ...
                $("#submitExistingClient").click(function(e) {
                    e.preventDefault();
                    var formData = $("#existingClientForm").serialize();
